export const images = {
  ...
  sebathiSymbol: "/assets/starforge-symbol.svg",
  sebathiWhiteSymbol: "/assets/starforge-symbol-white.svg",
...
export const sebathiServices = [
  "Photo generating",
  "Photo enhance",
  "Seamless Integration",
];

export const sebathiServicesIcons = [
  recording03,
  recording01,
  disc02,
  chromecast,
