# PowerShell Script to Capture Screenshot of Sebathi V3 App with Longer Wait Time
...
# Wait longer for browser to open and page to load completely
Write-Host "Waiting 15 seconds for page to fully load and render..." -ForegroundColor Yellow
...
# Also copy to assets folder for GitHub
Copy-Item $finalPath -Destination "assets\sebathi-banner.png" -Force

Write-Host "`n✅ SUCCESS! Banner screenshot saved to both:" -ForegroundColor Green
Write-Host "  - $finalPath" -ForegroundColor Cyan
Write-Host "  - assets\sebathi-banner.png" -ForegroundColor Cyan
